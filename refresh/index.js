...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var token, secret, decodedToken, params, item, payload1, payload2, accessToken, refreshToken, e_1;
    var _a, _b;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _d.trys.push([1, 6, , 7]);
                token = (_c = event.headers) === null || _c === void 0 ? void 0 : _c['token'];
                ...
                try {
                    ...
                    if (e instanceof jwt.TokenExpiredError)
                        return [2 /*return*/, toReturn(403, 'Refresh Token Expired')];
